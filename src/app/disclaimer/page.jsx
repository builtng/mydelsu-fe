...
// myDelsu · Disclaimer page. Route: /disclaimer

const BLUE = "#5a8abb";
const BLUE_DARK = "#4574a4";
const CURRENT = "/disclaimer";
...
export default function MyDelsuDisclaimer() {
    ...
    <div className="site">
      ...
      <main className="main">
        <article className="page">
          <header className="phead"><span className="eyebrow">Legal</span><h1>Disclaimer</h1><p className="updated">Last updated {UPDATED}</p></header>
          <div className="prose">
            <h2>General information</h2>
            <p>myDelsu provides information and resources for general use. We share them in good faith, but we make no promise that everything is complete or free of error.</p>
            <h2>Not affiliated with the university</h2>
            <p>myDelsu is an independent platform. We are not owned by, run by, or officially endorsed by Delta State University. For official matters, always confirm with the university directly.</p>
            <h2>Accuracy</h2>
            <p>Admission details, school fees, and policies can change. Please treat our information as a helpful guide and verify anything important with official DELSU sources before you act on it.</p>
            <h2>About Manna</h2>
            <p>Manna is a free goodwill giveaway. There is no purchase, no stake, and no cost to enter, and it is not a game of chance you pay to play. Taking part does not guarantee that you will win.</p>
            <h2>Not professional advice</h2>
            <p>Academic tools such as calculators, and any financial or budgeting information, are for guidance only. They are not a substitute for professional advice.</p>
            <h2>External links</h2>
            <p>Our platform may link to other sites and tools. We are not responsible for their content or their practices.</p>
            <h2>Contact</h2>
            <p>Questions about this disclaimer can be sent to {SUPPORT_EMAIL}.</p>
          </div>
        </article>
      </main>
