...
.ghost{ background:#fff; color:var(--ink); border:1px solid var(--line); border-radius:11px; padding:11px 20px; font-size:14.5px; font-weight:700; text-decoration:none; cursor:pointer; }
